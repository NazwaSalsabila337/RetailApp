...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary shadow-sm">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">Retail Aplication</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
              <ul class="navbar-nav ms-auto">
                  ...
                  <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="?modul=persediaan">Persedian Barang</a></li>
  ...
  <div class="container-fluid py-3 bg-white shaodow-sm">
    <div class="container">
        <?php
        if(isset($_GET['modul'])){
          if($_GET['modul']=="home"){
  ...
  <div class="text-center py-3">
    <span>Copyright &copy; 2024 | Retail Aplication</span>
  </div>
