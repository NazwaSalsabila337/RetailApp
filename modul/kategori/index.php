<div class="border-bottom d-flex justify-content-between py-3">
    <h4>Data kategori</h4>
    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalTambah"><i class="bi bi-plus-circle-fill"></i> Tambah Kategori</button>
    <!-- Modal -->
...
<table id="myTable">
    ...
    <tbody>
        ...
        $resul_kategori = $mysqli->query($sql_kategori);
        $no = 0;
        while($row_kategori = $resul_kategori->fetch_assoc()){
            $no++;
        ?>
            <tr>
                <td><?= $no;?></td>
                ...
                <td>
                        ...
                        <div class="modal fade" id="modalEdit<?= $row_kategori['id_kategori'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="modul/kategori/proses.php?aksi=edit&id=<?= $row_kategori['id_kategori'];?>" method="post" method="post">
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                <label class="form-label" for="namakategori">Nama kategori</label>
                    ...
                    <a href=""data-bs-toggle="modal" data-bs-target="#modalHapus<?= $row_kategori['id_kategori'];?>" class="text-danger"><i class="bi bi-trash3"></i></a>              
